...
def main():
	...
	print "-----BINARY ADAPTIVE BOOSTING----"
	...
	for i in range(0,iterations):
		...
		print "Probability normalization factor: "+str(z)+"\n"
		...
		print "Probability after normalization: "
		...
		zs = zs*z
		print "error of the boosted classifier: "+str(float(errs)/len(values))+","+str(errs)+" mistakes\n"
		print "bound on Et: "+str(zs)+"\n"
		print "===============================================================================================\n"
		f2.write("error of the boosted classifier: "+str(float(errs)/len(values))+","+str(errs)+" mistakes\n")
